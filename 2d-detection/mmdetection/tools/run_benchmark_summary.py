...
def train_and_eval_model(
    ...
    default_work_dir = (
        Path(bench_cfg.get("project", "runs/benchmarks"))
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        default="configs/benchmarks/faster-rcnn_r50_fpn_dcn_fisheye_benchmark.yaml",
        help="Path to benchmark YAML config.",
    )
    parser.add_argument(
        "--out",
        default="runs/benchmarks/summary_fisheye_mmdet.csv",
