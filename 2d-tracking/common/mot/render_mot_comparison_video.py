...
Example:
    ...
    python common/mot/render_mot_comparison_video.py \
        ...
        --frames-dir D:/AOC/datasets/aghri-test/footpath1_p1_oj+mk+gl_1walk+check_st_11_12_2024_1_label/sensor_data/cam_zed_rgb \
